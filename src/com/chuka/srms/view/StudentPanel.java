...
public class StudentPanel extends JPanel {
    ...
    private JPanel createFormPanel() {
        ...
        cmbAcademicStatus = new JComboBox<>(new String[]{"Active", "On Probation", "Cleared for Graduation", "Graduated"});
    ...
    private Student getStudentFromForm() throws Exception {
        ...
        // Validation
        if (studentId.isEmpty()) throw new IllegalArgumentException("Student ID is required");
        ...
        if (dobStr.isEmpty()) throw new IllegalArgumentException("Date of birth is required");
        if (major.isEmpty()) throw new IllegalArgumentException("Major is required");
